...
//       />
//       <h1 className="main-container"> Adedoyin (Bisola) Folarin</h1>
//       <h1 className="main-container"> Hi! Welcome to my Website. Here, you can find my technical projects, educational background and contact information.</h1>
//       <select onChange={handleSelectChange} defaultValue="">
//       <option value="" disabled>Choose an option</option> 
//         <option value="/projects">Bisola's work</option>
